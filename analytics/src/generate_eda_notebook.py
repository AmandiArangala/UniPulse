"""
UniPulse Exploratory Data Analysis (EDA) Notebook Generator (generate_eda_notebook.py)
"""
...
def build_eda_notebook():
    notebook_dir = os.path.join("analytics", "notebooks")
    os.makedirs(notebook_dir, exist_ok=True)
    notebook_path = os.path.join(notebook_dir, "eda_summary_analytics.ipynb")
    ...
    logging.info(f"[OK] Created Jupyter EDA Notebook at: {notebook_path}")
